...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    scores = None
    #############################################################################
    # NOTE: Perform the forward pass, computing the class scores for the input. #
    ...
    loss = 0
    #############################################################################
    # NOTE: Finish the forward pass, and compute the loss. This should include  #
    ...
    grads = {}
    #############################################################################
    # NOTE: Compute the backward pass, computing the derivatives of the weights #
